...
namespace TemporaTasks.Core
{
    public static class KeyboardHooks
    {
        ...
        public static void Register()
        {
            ...
            if (!RegisterHotKey(handle, HOTKEY_ID_1, MOD_WIN, VK_KEY_1)) mainWindow.HotkeyRegFailNotif();
            if (!RegisterHotKey(handle, HOTKEY_ID_2, MOD_WIN, VK_KEY_2)) mainWindow.HotkeyRegFailNotif();
        }
